...
export function PricingFree() {
  ...
  return (
    <Card style={style} className="container card">
      <h5  className="card-title text-muted text-uppercase text-center member">Free</h5>
          <h6 class="card-price text-center"><span class="period">$0</span>/month</h6>
          <hr  style={{
              color: '#000000',
            ...
            <List>
                ...
                <ListItem>
                 ...
                 <ListItem>
                  ...
                  primary="Unlimited Public Access"
                  />
                </ListItem>
                <ListItem>
                  <ListItemIcon>
